...
declare class TKDataForm extends UIView {
	...
	onValidationResultValuePropertyEditor(result: boolean, validatedValue: any, property: TKEntityProperty, editor: TKDataFormEditor): void;
...
interface TKDataFormDelegate extends NSObjectProtocol {
	...
	dataFormDidFinishValidation?(dataForm: TKDataForm, result: boolean): void;

	dataFormDidFinishCommit?(dataForm: TKDataForm, result: boolean): void;
...
declare class TKSlideView extends UIView {
	...
	swipeDirection: TKSwipeDirection;
...
declare class TKFeedback extends NSObject {

	static alloc(): TKFeedback; // inherited from NSObject

	static dataSource(): TKFeedbackDataSource;

	static feedbackIsShown(): boolean;

	static feedbackSettings(): TKFeedbackSettings;

	static new(): TKFeedback; // inherited from NSObject

	static sendFeedback(): void;

	static setDataSource(dataSource: TKFeedbackDataSource): void;

	static showFeedback(): void;
}

declare class TKFeedbackController extends UIViewController {

	static alloc(): TKFeedbackController; // inherited from NSObject

	static new(): TKFeedbackController; // inherited from NSObject

	contentController: UIViewController;

	dataSource: TKFeedbackDataSource;

	showOnShake: boolean;

	constructor(o: { contentController: UIViewController; });

	initWithContentController(contentController: UIViewController): this;
...
interface TKFeedbackDataSource extends NSObjectProtocol {

	userEmail?: string;

	userName: string;

	addFeedbackCompletionHandler(item: TKFeedbackItem, handler: (p1: NSError) => void): void;

	addFeedbackItemsCompletionHandler(feedbackItems: NSArray<any>, handler: (p1: NSError) => void): void;

	addSubItemForKeySubItemCompletionHandler?(key: string, item: TKFeedbackItem, handler: (p1: NSError) => void): void;

	deleteWithKeyCompletionHandler(key: string, handler: (p1: NSError) => void): void;

	editWithKeyStateCompletionHandler(key: string, state: string, handler: (p1: NSError) => void): void;

	feedbackItems(handler: (p1: NSArray<any>, p2: NSError) => void): void;

	feedbackItemsByStateCompletionHandler?(state: string, handler: (p1: NSArray<any>, p2: NSError) => void): void;

	feedbackItemsByStateSkipCompletionHandler?(state: string, skip: number, handler: (p1: NSArray<any>, p2: NSError) => void): void;

	imageForKeyCompletionHandler?(key: string, handler: (p1: UIImage, p2: NSError) => void): void;

	subItemsForKeyCompletionHandler?(key: string, handler: (p1: NSArray<any>, p2: NSError) => void): void;
}
declare var TKFeedbackDataSource: {

	prototype: TKFeedbackDataSource;
};

declare class TKFeedbackItem extends NSObject implements NSCoding {

	static alloc(): TKFeedbackItem; // inherited from NSObject

	static new(): TKFeedbackItem; // inherited from NSObject
	...
	addSubItem(item: TKFeedbackItem): void;

	encodeWithCoder(aCoder: NSCoder): void;

	initWithCoder(aDecoder: NSCoder): this;

	insertSubItemAtIndex(item: TKFeedbackItem, index: number): void;

	subItems(): NSArray<any>;
}

declare class TKFeedbackSettings extends NSObject {

	static alloc(): TKFeedbackSettings; // inherited from NSObject

	static new(): TKFeedbackSettings; // inherited from NSObject

	feedbackMenuMyFeedbackCaption: string;

	feedbackMenuSendCaption: string;

	feedbackMenuSettingsCaption: string;

	feedbackSentAlertText: string;

	feedbackSentAlertTitle: string;

	feedbackTitle: string;

	showFeedbackSentAlert: boolean;
}

declare class TKPlatformFeedbackSource extends NSObject implements TKFeedbackDataSource {

	static alloc(): TKPlatformFeedbackSource; // inherited from NSObject

	static new(): TKPlatformFeedbackSource; // inherited from NSObject
	...
	userEmail: string; // inherited from TKFeedbackDataSource

	userName: string; // inherited from TKFeedbackDataSource

	readonly  // inherited from NSObjectProtocol

	constructor(o: { key: string; });

	constructor(o: { key: string; uid: string; });

	constructor(o: { key: string; uid: string; apiBaseURL: string; parameters: NSDictionary<any, any>; });
	...
	initWithKey(apiKey: string): this;

	initWithKeyUid(apiKey: string, uid: string): this;

	initWithKeyUidApiBaseURLParameters(apiKey: string, uid: string, apiBaseUrl: string, parameters: NSDictionary<any, any>): this;
...
declare class TelerikAppFeedback extends NSObject {

	static alloc(): TelerikAppFeedback; // inherited from NSObject

	static new(): TelerikAppFeedback; // inherited from NSObject

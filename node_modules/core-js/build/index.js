...
(function(){
  ...
  ref$ = require('nativescript-node/fs'), readFile = ref$.readFile, writeFile = ref$.writeFile, unlink = ref$.unlink;
  ref$ = require('path-browserify'), basename = ref$.basename, dirname = ref$.dirname, join = ref$.join;
